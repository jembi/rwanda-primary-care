...
public class CreateNewPatientController {
    ...
    public String confirmIdNumber(
            ...
            @RequestParam(required=false,value="NID_Number") Integer nid,
    ...
    public String processSubmit(
            ...
            @RequestParam(required=false, value="CR") String cr,
    	...
    	try{
	        ...
	        if (pos > 0){
	            try {
		            ...
		            log.info(ex.getMessage().endsWith("obx"));
	            }
	        }
    		...
    		log.info(e.getMessage().contains("obx"));
    		throw new PrimaryCareException(e);
