...
<c:set var="yoStr"><spring:message code="rwandaprimarycare.touchscreen.yearsOld"/></c:set>
	<c:when test="${size == 'small'}">
		<c:set var="buttonLabel"
			value="${fn:toUpperCase(patient.personName.familyName)} ${patient.personName.givenName} -${patient.age}${yoStr} ${patient.gender} "/>
	</c:when>
	<c:otherwise>
		<c:set var="yoStr"><spring:message code="rwandaprimarycare.touchscreen.yearsOld"/></c:set>
		<c:set var="buttonLabel" value="${fn:toUpperCase(patient.personName.familyName)} ${patient.personName.givenName} -${patient.age}${yoStr} ${patient.gender} "/>
	</c:otherwise>
</c:choose>
