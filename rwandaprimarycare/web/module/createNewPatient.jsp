	...
	<table>
		<tr>
			...
			<td><touchscreen:textInput required="true"
					label="${rwandanName}" name="familyNameCreate"
		...
		<tr>
			...
			<td><touchscreen:textInput required="true"
					label="${christianName}" name="givenNameCreate"
		...
		<tr>
			...
			<Td><c:set var="bDay">
				...
				</c:set> <touchscreen:numberInput required="false" name="birthdateDayCreate"
					value="${param.birthdateDay}"
					label="${bDay} (${orLeaveBlank} ${param.age})" min="1" max="31" />
				<touchscreen:numberInput required="false"
					name="birthdateMonthCreate" value="${param.birthdateMonth}"
					label="${bMonth} (${orLeaveBlank} ${param.age})" min="1" max="12" />
				<touchscreen:numberInput required="false" name="birthdateYearCreate"
		...
		<tr>
			...
			<c:if test="${param.nid != null}">
				...
				<c:choose>
					<c:when
						...
						name="addNationalIdentifier" value=""
						/></td>
						
					</c:when>
					<c:otherwise>
						<td><touchscreen:numberInput required="false" label="${nidStr}"
						name="addNationalIdentifier" value="${param.nid}"
						 /></td>
					</c:otherwise>
			...
			<c:if test="${param.nid == null}">
				<td><touchscreen:numberInput required="false" label="${nidStr}"
						name="addNationalIdentifier" value=""/></td>
			</c:if>
		</tr>
		...
		<tr>
			...
			<td><touchscreen:textInput required="false"
					label="${CountryStr}" name="COUNTRY" value="Rwanda"
					allowFreeText="true"
		...
		<tr>
			...
			<c:if test="${param.province == null}">
				<td><touchscreen:textInput required="false"
						label="${ProvinceStr}" name="PROVINCE" value="${searchPROVINCE}"
						allowFreeText="true"
			...
			<c:if test="${param.province != null}">
				<td><touchscreen:textInput required="false"
						label="${ProvinceStr}" name="PROVINCE" value="${param.province}"
						allowFreeText="true"
						ajaxURL="findPatientByNameAjax.form?searchType=PROVINCE&search="
						javascriptAction="updateAddressHierarchyCache()" /></td>
			</c:if>
		...
		<tr>
			...
			<c:if test="${param.district == null}">
				<td><touchscreen:textInput required="false"
						label="${DistrictStr}" name="DISTRICT" value="${searchDISTRICT}"
						allowFreeText="true"
			...
			<c:if test="${param.district != null}">
				<td><touchscreen:textInput required="false"
						label="${DistrictStr}" name="DISTRICT" value="${param.district}"
						allowFreeText="true"
						ajaxURL="findPatientByNameAjax.form?searchType=DISTRICT&search="
						javascriptAction="updateAddressHierarchyCache()" /></td>
			</c:if>
		...
		<tr>
			...
			<c:if test="${param.sector == null}">
				<td><touchscreen:textInput required="false"
						label="${SectorStr}" name="SECTOR" value="${searchSECTOR}"
						allowFreeText="true"
			...
			<c:if test="${param.sector != null}">
				<td><touchscreen:textInput required="false"
						label="${SectorStr}" name="SECTOR" value="${param.sector}"
						allowFreeText="true"
						ajaxURL="findPatientByNameAjax.form?searchType=SECTOR&search="
						javascriptAction="updateAddressHierarchyCache()" /></td>
			</c:if>
		...
		<tr>
			...
			<c:if test="${param.cell == null}">
				<td><touchscreen:textInput required="false" label="${CellStr}"
						name="CELL" value="${searchCELL}" allowFreeText="true"
						ajaxURL="findPatientByNameAjax.form?searchType=CELL&search="
						javascriptAction="updateAddressHierarchyCache()" /></td>
			</c:if>
			<c:if test="${param.cell != null}">
				<td><touchscreen:textInput required="false" label="${CellStr}"
						name="CELL" value="${param.cell}" allowFreeText="true"
						ajaxURL="findPatientByNameAjax.form?searchType=CELL&search="
						javascriptAction="updateAddressHierarchyCache()" /></td>
			</c:if>
		...
		<tr>
			...
			<c:if test="${param.address1 == null}">
				<td><touchscreen:textInput required="false"
						label="${UmuduguduStr}" name="UMUDUGUDU"
			...
			<c:if test="${param.address1 != null}">
				<td><touchscreen:textInput required="false"
						label="${UmuduguduStr}" name="UMUDUGUDU" value="${param.address1}"
						allowFreeText="true"
						ajaxURL="findPatientByNameAjax.form?searchType=UMUDUGUDU&search="
						javascriptAction="updateAddressHierarchyCache()" /></td>
			</c:if>
		...
		<tr>
			...
			<td><touchscreen:textInput required="false" label="${MomStr}"
					name="mothersNameCreate" value="${param.mothersName}"
					allowFreeText="true"
		...
		<tr>
			...
			<td><touchscreen:textInput required="false" label="${DadStr}"
					name="fathersNameCreate" value="${param.fathersName}"
					allowFreeText="true"
